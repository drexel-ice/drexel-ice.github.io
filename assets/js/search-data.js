...
ninja.data = [{id: "nav-team",
          ...
          title: "news",
          description: "News and updates from the ICE Lab at Drexel University.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-eda-learn-machine-learning-for-electronic-design-automation",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/ml-for-eda/";
          ...
          section: "Team",handler: () => {
            ...
            },},{id: "team-zakir-jiwani",
          title: 'Zakir Jiwani',
          description: "B.S. Student, Electrical &amp; Computer Engineering | zj77@drexel.edu",
          section: "Team",handler: () => {
              window.location.href = "/team/zakir-jiwani/";
            },},{id: "team-ziyi-chen",
          title: 'Ziyi Chen',
